...
const CreateTaskDialog = ({ showCreateTask, setShowCreateTask, projectId }) => {
  ...
  return showCreateTask ? (
    ...
    dark:bg-black/60 backdrop-blur"
    >
      <div
        className="bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800
       rounded-lg w-full max-w-md p-6 text-zinc-900 dark:text-white"
      >
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded dark:bg-zinc-900 border border-zinc-300
               dark:border-zinc-700 px-3 py-2 text-zinc-900 dark:text-zinc-200 text-sm mt-1
