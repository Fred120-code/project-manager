...
const RecentActivity = () => {
  ...
  return (
    <div
      className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200
      ...
      <div className="p-0">
        {tasks.length === 0 ? (
          <div className="p-12 text-center">
            ...
            >
              <Clock className="size-8 text-zinc-600 dark:text-zinc-500" />
            </div>
