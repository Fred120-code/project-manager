  ...
  return (
    <div className=" relative m-4" ref={dropdownRef}>
      <button
        ...
        className="w-full flex items-center justify-between p-3 h-auto text-left rounded
      ...
      {isOpen && (
        <div
          className=" absolute z-50 w-64 bg-white dark:bg-zinc-900 border
          border-gray-200 dark:border-zinc-700 rounded shadow-lg top-full left-0"
        >
          <div className="p-2">
          ...
          <div className="p-2 cursor-pointer rounded group hover:bg-gray-100 dark:hover:bg-zinc-800">
            <p
              className="flex items-center text-xs gap-2 my-1 w-full text-blue-600 dark:text-blue-400 
