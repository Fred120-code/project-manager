    ...
    currentWorkspace && (
      ...
      >
        <div className="border-b border-zinc-200 dark:border-zinc-800 p-4 flex items-center justify-between">
          ...
          <Link
            to={"/projects"}
            className="flex items-center text-sm text-zinc-600 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300"
          >
          ...
          {projects.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <button
                ...
                className="mt-4 px-4 py-2 text-sm bg-gradient-to-br from-blue-500 to-blue-600 text-white
                             dark:text-zinc-200 rounded hover:opacity-90 transition"
              >
